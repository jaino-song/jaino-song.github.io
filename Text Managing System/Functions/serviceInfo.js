...
function generateGreetingMsg(name) {
    ...
    산후관리서비스 관련 안내사항 보내드립니다 :)
    
    ▶관리사님의 근무시간은 오전 9시부터 오후 6시까지이며 점심 식사 시간이 포함된 1시간 휴게시간이 있습니다.
    ...
    산모 음식 준비, 
    아기와 산모가 머무는 방의 청소와 거실과 화장실의 간단한 청소 등의 일들을 하시는데 묵은 빨래, 대청소, 베란다 청소 등의 과중한 일들은 하지 않으십니다.
    
    그 외 산모님께서 도움이 필요한 일이 생겼을 시에, 그때그때 말씀하시면 거의 다 도와드립니다 :)
