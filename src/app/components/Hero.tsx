...
const Hero = () => {
    return (
        <section className="w-full min-h-[75vh] bg-neutral-800 inline-flex flex-col justify-center items-center px-4 sm:px-6">
            <div className="flex flex-col justify-center items-center gap-6 sm:gap-8 md:gap-10 max-w-6xl">
                ...
                <div className="flex flex-col sm:flex-row justify-start items-center gap-4 sm:gap-6 md:gap-8">
