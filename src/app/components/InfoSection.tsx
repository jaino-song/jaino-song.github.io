...
const InfoSection = ({ 
    ...
    return (
        <section id={id} className="w-full h-150 px-12 py-20 inline-flex flex-col justify-center items-center gap-15">
            <div className="w-200.5 h-22 inline-flex flex-col justify-center items-center gap-5">
                <div className="self-stretch text-center justify-start text-Main-Text text-4xl font-bold font-['Poppins']">
                    {title}
                </div>
                <div className="text-center justify-center text-Subtitle text-xl font-medium font-['Poppins'] leading-snug">
                    {subtitle}
                </div>
            </div>
            <div className="w-200.5 inline-flex justify-between items-center gap-12">
                <div className="w-[549px] h-60 inline-flex flex-col justify-center items-center gap-12">
                    <div className="self-stretch flex flex-col justify-start items-start gap-5">
                        <div className="self-stretch justify-start text-Text text-base font-medium font-['Poppins'] leading-normal">
                            {text}
                        </div>
                    </div>
